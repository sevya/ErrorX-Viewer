...
SOURCES = src/ProgressDialog.cc src/MainWindow.cc src/OptionsDialog.cc src/ConfirmFile.cc src/main.cc src/ErrorTab.cc src/SummaryTab.cc src/GeneTab.cc src/ClonotypeTab.cc src/DataTab.cc src/ParamsTab.cc src/qcustomplot.cc src/ErrorXWorker.cc src/gui_util.cc src/WelcomeTab.cc
